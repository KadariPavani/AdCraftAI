...
async def startup():
    ...
    print(f"  Languages: http://localhost:{port}/api/languages")
    print(f"  Stats:     http://localhost:{port}/api/stats")
    print(f"  Dataset API: http://localhost:{port}/api/dataset-summary")
    print(f"  Dataset UI:  http://localhost:{port}/dataset")
    print("=" * 70)
    print()
